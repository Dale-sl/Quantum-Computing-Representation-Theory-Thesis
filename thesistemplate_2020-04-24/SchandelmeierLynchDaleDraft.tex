...
and the orbit–stabilizer argument then recovers \(g\) uniquely.
 Base size is thus equivalent to classical query complexity for symmetric oracle discrimination,
  ...
  \begin{proof}
    We observe that $V$ is the permutation representation of $S_n / S_{n-1}$ \todo{expand on this or prove it maybe}, so using the permutation representation case of lemma $3.1.9$ we see that
    \begin{align*}
